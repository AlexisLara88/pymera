...
final class BusinessModuleTest extends CIUnitTestCase
{
    ...
    public function testAuthenticatedAccountReadsOnlyItsBusinessAndEscapesStoredContent(): void
    {
        ...
        $result->assertSee('44%');
        $result->assertSee('Perfil del negocio');
        $this->assertSame(14, substr_count($result->getBody(), 'class="context-help"'));
        $this->assertSame(14, substr_count($result->getBody(), 'class="context-help-trigger"'));
        ...
        $this->assertSame(8, substr_count($result->getBody(), 'data-context-help-placement="inside-right"'));
        $this->assertSame(5, substr_count($result->getBody(), 'data-context-help-placement="inside-left"'));
        ...
        $this->assertStringContainsString('business-help-acquisition-channels', $result->getBody());
        $this->assertStringNotContainsString('business-help-currency', $result->getBody());
        $this->assertStringNotContainsString('business-help-timezone', $result->getBody());
